...
$ virtualenv env
$
$ # Virtualenv modules installation (For Mac)
$ # python3 -m venv venv
...
### Troubleshooting
#### Error: `error in feedparser setup command: use_2to3 is invalid`
```
pip3 install "setuptools<58.0"
```
Then try reinstall the package again

#### Issue with "base 64 deprecation"
